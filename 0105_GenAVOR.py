...
def get_background_bbox2d(imgsize, bbox2d, times):
...
def get_image_roi(imagerootpath, bbox2dlist, filelist, outpath):
    ...
    for index in range(len(filelist)):
        ...
        # cut background
        bkbbox2d = get_background_bbox2d(img.size, bbox2dlist[index], times=2)
        # print(bkbbox2d)
...
def main():
    ...
    OUTPUT_PATH = f'{KITTI_PATH}/classification/210104_2back1fore/{MODE}/'
